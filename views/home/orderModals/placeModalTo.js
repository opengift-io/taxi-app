...
class PlaceModalToClass extends Component {
    ...
    componentDidMount() {
        this.setAddresses(this.props.to.short_name)
    }
        ...
        return (<Animated.View
            ...
            <View
                ...
                <TextInput
                    ...
                    defaultValue={this.props.to.short_name}
                    placeholder='Search...'
                    style={styles.input} />
...
export const PlaceModalTo = connect(
    ({ map }) => ({ map })
)(PlaceModalToClass)
